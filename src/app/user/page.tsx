...
export default function Home() {    
    ...
    useEffect (()=>{
        ...
        console.log("access token for user page :",accessToken)

        async function getData() {
            const url = "http://localhost:8080/protected/user";
            try {
                ...
                console.log("fetch requst error")
            }
            }
            getData()
    })
    ...
    return (
        ...
        <div className="w-96 h-[44rem] bg-white rounded-3xl shadow-lg overflow-hidden">
            ...
            <div className="w-64 h-40 m-auto pt-7">
            <Alert>
                <AlertTitle>Account Created Succesfully!</AlertTitle>
                <AlertDescription>
                <p className="text-red-500">Please do remember the account crediential.</p>
                </AlertDescription>
            </Alert>
            </div>
            <div className="w-full h-16 bg-gree">
            <div className="w-64 h-5/6 m-auto">
                {/* <Input type="text" placeholder="Account Number" className="pt-3"/> */}
                <Accordion type="single" collapsible>
                <AccordionItem value="item-1">
                    <AccordionTrigger>Your Account Number</AccordionTrigger>
                    <AccordionContent>
                    <h1>204549222</h1>
                    </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-2">
                    <AccordionTrigger>Your Account Balance</AccordionTrigger>
                    <AccordionContent>
                    <h1>Nu.0.00</h1>
                    </AccordionContent>
                </AccordionItem>
            ...
            <div className="h-24 w-full pl-36 pt-7">
            <Button type="button" onClick={()=>router.push('/login')}>Next</Button>
            </div>
